...
pub struct TextStyle {
    ...
    ///
    /// This is multiplied by the window scale factor and potentially the `UiScale`, but not
    /// text entity or camera scales.
    ///
    /// A new font atlas must be generated for every combination of font handle and scaled
    /// font size which can have a strong performance impact.
    pub font_size: f32,
    pub color: Color,
}
