...
mod tests {
    ...
    #[test]
    fn hex_color() {
        assert_eq!(Srgba::hex("FFF"), Ok(crate::consts::WHITE));
        assert_eq!(Srgba::hex("FFFF"), Ok(crate::consts::WHITE));
        assert_eq!(Srgba::hex("FFFFFF"), Ok(crate::consts::WHITE));
        assert_eq!(Srgba::hex("FFFFFFFF"), Ok(crate::consts::WHITE));
        assert_eq!(Srgba::hex("000"), Ok(crate::consts::BLACK));
        assert_eq!(Srgba::hex("000F"), Ok(crate::consts::BLACK));
        assert_eq!(Srgba::hex("000000"), Ok(crate::consts::BLACK));
        assert_eq!(Srgba::hex("000000FF"), Ok(crate::consts::BLACK));
